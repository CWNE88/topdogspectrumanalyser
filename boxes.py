...
class Boxes(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.widget.addItem(self.box_item)
        self.init_boxes()
    ...
    def init_boxes(self):
        # Initialize vertices, faces, and vertex colors as NumPy arrays
    ...
    def update_visualisation(self):
        ...
        centred = np.fft.fftshift(fft_result)
        mag = np.abs(centred)
        power = 20 * np.log10(mag + 1e-12)

        # Calculate heights and color values
        heights = power / 5
